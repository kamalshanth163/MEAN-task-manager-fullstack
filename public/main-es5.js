...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    "./src/app/pages/edit-task/edit-task.component.ts"); // import { NgModule } from "@angular/core";
  ...
  function srcAppPagesEditListEditListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    EditListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
  ...
  function srcAppPagesNewListNewListComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      _createClass(NewListComponent, [{
        ...
        value: function createList(title) {
          ...
          this.taskService.createList(title).subscribe(function (list) {
            console.log(list); // navigate to /lists/response._id
    ...
    NewListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
    ...
    function () {
      ...
      _createClass(NewTaskComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.route.params.subscribe(function (params) {
            _this10.listId = params["listId"]; // console.log(this.listId);
          });
        }
      }, {
        key: "createTask",
  ...
  function srcAppPagesTaskViewTaskViewComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! @angular/router */
    "./node_modules/@angular/router/fesm2015/router.js"); // import { Component, OnInit } from "@angular/core";
    ...
    function () {
      ...
      _createClass(TaskViewComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.route.params.subscribe(function (params) {
            if (params.listId) {
              _this12.selectedListId = params.listId;

              _this12.taskService.getTasks(params.listId).subscribe(function (tasks) {
                _this12.tasks = tasks;
              });
            } else {
              _this12.tasks = undefined;
            }
          });
        ...
        value: function onDeleteTaskClick(id) {
          ...
          this.taskService.deleteTask(this.selectedListId, id).subscribe(function (res) {
            _this14.tasks = _this14.tasks.filter(function (val) {
              return val._id !== id;
            });
            console.log(res);
          });
  ...
  function srcAppWebReqInterceptorTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! rxjs/operators */
    "./node_modules/rxjs/_esm2015/operators/index.js"); // import { Injectable } from "@angular/core";
    // import {
    //   HttpInterceptor,
    //   HttpHandler,
    //   HttpRequest,
        ...
        value: function intercept(request, next) {
          ...
          return next.handle(request).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (error) {
            ...
            if (error.status === 401) {
              // 401 error so we are unauthorized
              // refresh the access token
              return _this15.refreshAccessToken().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function () {
                request = _this15.addAuthHeader(request);
                return next.handle(request);
        ...
        value: function refreshAccessToken() {
          ...
          if (this.refreshingAccessToken) {
            return new rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"](function (observer) {
              _this16.accessTokenRefreshed.subscribe(function () {
            ...
            return this.authService.getNewAccessToken().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () {
              console.log("Access Token Refreshed!");
              _this16.refreshingAccessToken = false;

              _this16.accessTokenRefreshed.next();
            }));
          }
        }
      }, {
    ...
    WebReqInterceptor = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], WebReqInterceptor);
    /***/
  },
  ...
  function srcAppWebRequestServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function WebRequestService(http) {
        ...
        this.http = http; // this.ROOT_URL = "http://localhost:3000";
    ...
    WebRequestService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: "root"
    })], WebRequestService);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\Dell\Desktop\WebDev\Projects\Local Projects\task-manager\frontend\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
